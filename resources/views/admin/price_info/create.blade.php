                ...
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" novalidate data-parsley-validate
                              action="{{ url('admin/price_info') }}" method="post">
                            {{ csrf_field() }}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="off_site_fee" class="form-control col-md-7 col-xs-12" name="off_site_fee" placeholder="请输入异地还车费" required="required" value="" data-validate-minmax="0," type="number">
                                                            ...
                                                            ;
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="night_pickup_fee">夜间取车费</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="night_pickup_fee" class="form-control col-md-7 col-xs-12" name="night_pickup_fee" placeholder="请输入夜间取车费" required="required" value="" data-validate-minmax="0," type="number">
                                    </div>
                                </div>
                                                            ;
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="night_return_fee">夜间换车费</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="night_return_fee" class="form-control col-md-7 col-xs-12" name="night_return_fee" placeholder="请输入夜间换车费" required="required" value="" data-validate-minmax="0," type="number">
                                    </div>
                                </div>
                                                            ;
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="night_start">夜间开始时间</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="night_start" class="form-control col-md-7 col-xs-12" name="night_start" placeholder="请输入夜间开始时间" required="required" value="" type="text">
                                    </div>
                                </div>
                                                            ;
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="night_end">夜间结束时间</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="night_end" class="form-control col-md-7 col-xs-12" name="night_end" placeholder="请输入夜间结束时间" required="required" value="" type="text">
                                    </div>
                                </div>
                                                            ;
                                <div class="item form-group">
