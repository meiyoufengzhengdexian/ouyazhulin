                            ...
                            <div class="col-sm-12">
                                <table id="datatable" class="table table-striped table-bordered dataTable no-footer"
                                    ...
                                    <tr>
                                                                                                                                    <th width="35px">id</th>
                                                                                                                                                                                <th width="35px">订单</th>
                                                                                                                                                                                <th width="35px">还车公里数</th>
                                                                                                                                                                                <th width="35px">还车油量</th>
                                                                                                                                                                                <th width="35px">还车时间</th>
                                                                                                                                                                                <th width="35px">超小时费/每小时</th>
                                                                                                                                                                                <th width="35px">超公里费/每公里</th>
                                                                                                                                                                                <th width="35px">燃油费</th>
                                                                                                                                                                                <th width="35px">清洁费</th>
                                                                                                                                                                                <th width="35px">误工费</th>
                                                                                                                                                                                <th width="35px">其他费用</th>
                                                                                                                                                                                <th width="35px">备注</th>
                                                                                                                                                                                                                                                                                                                                                                                        <th width="75px">操作</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                                                                                                                    <td>{{ $v->id }}</td>
                                                                                                                                                                                ...
                                                                                                                                                                                <td>{{ $v->oil_fee }}</td>
                                                                                                                                                                                <td>{{ $v->cleaning_fee }}</td>
                                                                                                                                                                                <td>{{ $v->lost_wages }}</td>
                                                                                                                                                                                <td>{{ $v->oth_fee }}</td>
                                                                                                                                                                                <td>{{ $v->desc }}</td>
                                                                                                                                                                                                                                                                                                                                                
                                        <td>
                                            <a href="{{ url('admin/return_price/'.$v->id.'/edit')  }}" class="btn btn-info btn-xs">编辑</a>
                                            <a href="{{ url('admin/return_price', ['id'=>$v->id])  }}"
