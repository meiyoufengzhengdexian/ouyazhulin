                                ...
                                <table id="datatable" class="table table-striped table-bordered dataTable no-footer"
                                    ...
                                    <tr>
                                                                                                                                    <th width="35px">id</th>
                                                                                                                                                                                <th width="35px">价格</th>
                                                                                                                                                                                <th width="35px">值</th>
                                                                                                                                                                                <th width="35px">值类型</th>
                                                                                                                                                                                <th width="35px">浮动类型</th>
                                                                                                                                                                                <th width="35px">星期</th>
                                                                                                                                                                                <th width="35px">开始日期</th>
                                                                                                                                                                                <th width="35px">结束日期</th>
                                                                                                                                                                                <th width="35px">开始时间</th>
                                                                                                                                                                                <th width="35px">结束日期</th>
                                                                                                                                                                                <th width="35px">创建日期</th>
                                                                                                                                                                                                                                                                                                    <th width="75px">操作</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/price_float/'.$v->id.'/edit')  }}" class="btn btn-info btn-xs">编辑</a>
                                            <a href="{{ url('admin/price_float', ['id'=>$v->id])  }}"
