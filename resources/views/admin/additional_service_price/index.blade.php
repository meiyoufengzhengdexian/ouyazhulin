    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Additional_service_price列表</h3>
            </div>
                        ...
                        <div id="table" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="col-sm-12">
                                <table id="datatable" class="table table-striped table-bordered dataTable no-footer"
                                    ...
                                    <tr>
                                                                                                                                    <th width="35px">id</th>
                                                                                                                                                                                <th width="35px">增值服务</th>
                                                                                                                                                                                <th width="35px">关联价格</th>
                                                                                                                                                                                                                                                                                                                                                                                        <th width="75px">操作</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                                                                                                                    <td>{{ $v->id }}</td>
                                                                                                                                                                                <td>{{ $v->additional_service }}</td>
                                                                                                                                                                                <td>{{ $v->price }}</td>
                                                                                                                                                                                                                                                                                                                                                
                                        <td>
                                            <a href="{{ url('admin/additional_service_price/'.$v->id.'/edit')  }}" class="btn btn-info btn-xs">编辑</a>
                                            <a href="{{ url('admin/additional_service_price', ['id'=>$v->id])  }}"
