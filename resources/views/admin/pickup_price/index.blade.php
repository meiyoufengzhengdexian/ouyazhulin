                        ...
                        <div id="table" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="col-sm-12">
                                <table id="datatable" class="table table-striped table-bordered dataTable no-footer"
                                    ...
                                    <tr>
                                                                                                                                    <th width="35px">id</th>
                                                                                                                                                                                <th width="35px">取车时间</th>
                                                                                                                                                                                <th width="35px">订单</th>
                                                                                                                                                                                <th width="35px">取车油量</th>
                                                                                                                                                                                <th width="35px">取车公里数</th>
                                                                                                                                                                                <th width="35px">已付金额</th>
                                    ...
                                    <tr>
                                                                                                                                    <td>{{ $v->id }}</td>
                                                                                                                                                                                ...
                                                                                                                                                                                <td>{{ $v->paid }}</td>
                                                                                                                                                                                <td>{{ $v->oth_fee }}</td>
                                                                                                                                                                                <td>{{ mb_substr($v->desc, 0, 50) }}</td>
                                                                                                                                                                                                                                                                                                                                                
                                        <td>
                                            <a href="{{ url('admin/pickup_price/'.$v->id.'/edit')  }}" class="btn btn-info btn-xs">编辑</a>
                                            <a href="{{ url('admin/pickup_price', ['id'=>$v->id])  }}"
